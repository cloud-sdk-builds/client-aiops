...
[`@aws-sdk/client-aiops`](https://www.npmjs.com/package/@aws-sdk/client-aiops/v/3.962.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-aiops@3.962.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-g5Le/g8yK+lX+eVIH8ouWbHSZAumnvc866CGMDFHkv0JeLP4XZ/IR/Pr7G4EOR0l
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-aiops": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-aiops@3.962.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-aiops@3.962.0/index.min.mjs": "sha384-g5Le/g8yK+lX+eVIH8ouWbHSZAumnvc866CGMDFHkv0JeLP4XZ/IR/Pr7G4EOR0l"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-aiops/blob/refs/tags/3.962.0/LICENSE
```
